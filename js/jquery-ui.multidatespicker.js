			...
			init : function( options ) {
				...
				var mdp_events = {
					...
					onSelect : function(dateText, inst) {
						...
						var diffMonth = dateText.split('/')[1] - (today_date.getMonth() + 1);
						diffMonth = diffMonth < 0 ? diffMonth + 12 : diffMonth;
						...
						if (this.multiDatesPicker.mode == 'normal' && this.multiDatesPicker.dates.picked.length > 0 && this.multiDatesPicker.pickableRange) {
							...
							$this
								...
								.datepicker("option", "defaultDate", "+" + diffMonth + "m")
						} else {
							$this
					...
					onClose: function(dateText, inst) {
						if(this.tagName == 'INPUT' && this.multiDatesPicker.changed) {
							...
							setTimeout('$("#'+inst.id+'").datepicker("show")', 10);
						}
